...
20.times { hit['Internet Explorer', 'Windows', '2012-05-04'] }
19.times { hit['Android', 'Android', '2012-05-04'] }
5.times  { hit['Firefox', 'GNU/Linux', '2012-05-04'] }
2.times  { hit['Firefox', 'OS X', '2012-05-05'] }
2.times  { hit['Safari', 'iOS', '2012-05-04'] }
