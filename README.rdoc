...
== Loading
    ...
    # Since Gruff's dependencies can a challenge to install, Graphene's Gruff module is not
    # loaded by default. If you have Gruff installed, you may manually load graphene/gruff
...
Integration with the tablizer gem provices quick ASCII tables.
